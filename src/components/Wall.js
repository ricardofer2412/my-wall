...
class Wall extends React.Component {
  ...
  addPost = (e) => {
    ...
    const newPostsList = [...this.state.postsList, newPost];
    this.postRef
      .doc(postId)
      .set(newPost)
      .then((res) => {
